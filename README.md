...
- <a id=2-3>常量和变量</a>
    ...
    >代码位置Day2\LivingExample-5\main.go
    - 4. 变量
        ...
        - 4.2 变量的作用域
            ...
            ```
            >练习下列程序输出的是什么，代码位置``Day2\LivingExample-11\main.go``
            ```go
            package main
...
- 4. 类型转换
    ...
    ```
- <a id=2-5>字符串类型</a>
    - 字符串拼装操作Day2\LivingExample-12\main.go
    - 字符串反转：代码位置Day2\LivingExample-13\main\main.go
